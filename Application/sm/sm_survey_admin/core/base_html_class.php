...
class base_html
{
    ...
    function draw_controls($type='', $title='')
    {
        ...
        switch($type)
        {
            ...
            case 'add'      :
            case 'edit'     :
            default         : $this->autofocus($first_field);
                              $this->draw_submit_cancel(FALSE);
                              break;
        }
    ...
    function draw_controls_mf($title='')
    {
        ...
        $this->draw_multifield_auto($title, $multifield_settings, $num_var, $count_var, $button_var);
    }
    ...
    function draw_footer()
    {
        ...
        {
            echo "<script>window.location.hash = '$anchor_tag';</script>";
        }
