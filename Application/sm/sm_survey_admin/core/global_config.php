<?php
define('GLOBAL_PROJECT_NAME', 'SM Survey and Data Analysis');
define('GLOBAL_SESSION_NAME', 'Cf0e2e0c1');
...
define('DEFAULT_DB_USE' , 'survey_analysis');

//Paths and directory names
define('BASE_DIRECTORY', 'sm/sm_survey_admin');
