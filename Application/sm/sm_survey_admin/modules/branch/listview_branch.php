...
//****************************************************************************************
require 'path.php';
init_cobalt('View branch');

$page_title       = 'ListView: %%';
$db_subclass      = 'branch';
$html_subclass    = 'branch_html';
$arr_pkey_name    = array('branch_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add branch';
$edit_link        = 'Edit branch';
$delete_link      = 'Delete branch';
$view_link        = 'View branch';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_branch.php';
$edit_page        = 'edit_branch.php';
$delete_page      = 'delete_branch.php';
$view_page        = 'detailview_branch.php';
$csv_page         = 'csv_branch.php';
$report_page      = 'reporter_branch.php';
