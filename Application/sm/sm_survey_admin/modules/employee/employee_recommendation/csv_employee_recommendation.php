...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel'])
    {
        ...
        redirect("listview_employee_recommendation.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_employee_recommendation_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_employee_recommendation->export_to_csv();
