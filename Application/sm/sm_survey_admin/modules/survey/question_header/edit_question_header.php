...
//****************************************************************************************
require 'path.php';
init_cobalt('Edit question header');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_question_header->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            ...
            for($a=0; $a<$question_details_count;$a++)
            {
                ...
                $dbh_question_details->add($param);
            }


            $dbh_question_header->edit($arr_form_data);
