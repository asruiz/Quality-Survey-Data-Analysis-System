...
$page_title       = 'ListView: %%';
$db_subclass      = 'question_header';
$html_subclass    = 'question_header_html';
$arr_pkey_name    = array('question_header_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add question header';
$edit_link        = 'Edit question header';
$delete_link      = 'Delete question header';
$view_link        = 'View question header';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_question_header.php';
$edit_page        = 'edit_question_header.php';
$delete_page      = 'delete_question_header.php';
$view_page        = 'detailview_question_header.php';
$csv_page         = 'csv_question_header.php';
$report_page      = 'reporter_question_header.php';
