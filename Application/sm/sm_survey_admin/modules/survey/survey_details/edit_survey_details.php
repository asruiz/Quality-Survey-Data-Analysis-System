...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        $message .= $dbh_survey_details->sanitize($arr_form_data)->lst_error;
        extract($arr_form_data);

        if($dbh_survey_details->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            ...
            $dbh_survey_details->edit($arr_form_data);
