...
$page_title       = 'ListView: %%';
$db_subclass      = 'survey_details';
$html_subclass    = 'survey_details_html';
$arr_pkey_name    = array('survey_details_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add survey details';
$edit_link        = 'Edit survey details';
$delete_link      = 'Delete survey details';
$view_link        = 'View survey details';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_survey_details.php';
$edit_page        = 'edit_survey_details.php';
$delete_page      = 'delete_survey_details.php';
$view_page        = 'detailview_survey_details.php';
$csv_page         = 'csv_survey_details.php';
$report_page      = 'reporter_survey_details.php';
